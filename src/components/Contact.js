    ...
    <Container className="footer-bg justify-content-center" id="contact" fluid>
      <Row className="page-scaler pad justify-content-center items-center text-center mt-5">
        <svg
          ...
          height="35"
          fill="#FDFEFF"
          className="bi bi-person-lines-fill mt-5 mb-3"
          viewBox="0 0 16 16"
        >
          <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z" />
        </svg>
        <h4 className="white-text text-center headers mt-3">GET IN TOUCH</h4>
          <div className="col-lg reveal-inner text-center mt-2">
            <span>
              <Button
                href="tel:+20 101 426 8239"
                style={{ borderRadius: "50%" }}
                variant="light"
                className="btn-sm m-2 mt-3 mb-3 p-1 icons"
                rel="noreferrer"
                id="icons"
              >
                <svg
        ...
        <footer className="white-text text-center mb-3 reveal-inner">
          <Button
            onClick={scrollToTop}
            style={{ borderRadius: "50%" }}
            variant="light"
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="bi bi-arrow-up-circle p-1 rotating-icons"
              viewBox="0 0 16 16"
            >
              <path
                fillRule="evenodd"
